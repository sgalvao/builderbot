  ...
  return (
    <div className="flex flex-col items-center w-full overflow-x-hidden ">
      ...
      <Stack spacing={10} mx="auto" maxW="3xl" my="20">
        ...
        <p>
          At HackLeads, accessible from https://www.hackleads.com.br, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by HackLeads and how we use it.
        </p>
        ...
        <p>
          ...
          shared and/or collect in HackLeads. This policy is not applicable to
        ...
        <p>
          HackLeads follows a standard procedure of using log files. These files
        ...
        <p>
          ...
          advertising partners of HackLeads.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on HackLeads, which are sent
        ...
        <p>
          Note that HackLeads has no access to or control over these cookies
        ...
        <p>
          HackLeads Privacy Policy does not apply to other advertisers or
        ...
        <p>
          HackLeads does not knowingly collect any Personal Identifiable
